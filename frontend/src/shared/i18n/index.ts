...
const resources = {
  "zh-CN": {
    translation: {
      ...
      updates: {
        ...
        latestVersion: "上游候选版本",
        latestVersionHelp: "最近一次从原项目 GitHub Releases 获取的候选补丁版本；不会自动替换当前分支。",
        statusLabel: "候选状态",
        statusLabelHelp: "当前自有分支与上游候选版本的比较结果，仅供人工评审和选择性移植。",
        checkedAt: "上次检查",
        ...
        releaseNotes: "更新说明",
        releaseNotesHelp: "原项目 GitHub Release 提供的候选变更摘要，尚未构成当前生产契约。",
        noReleaseNotes: "该版本没有更新说明。",
        notChecked: "尚未获取",
        neverChecked: "尚未成功检查",
        available: "发现上游候选 {{version}}",
        currentSummary: "当前运行 {{version}}",
        status: {
          unchecked: "尚未检查",
          up_to_date: "没有更新的上游候选",
          update_available: "发现上游候选",
          check_failed: "检查失败",
        },
      },
      nav: {
  ...
  en: {
    translation: {
      ...
      updates: { title: "About & upstream candidates", noteTitle: "Note", noteDescription: "This is an owned production fork. The original project is only a candidate patch source; no upstream release replaces the running contract automatically. You must also comply with Grok's official terms of use and applicable local laws.", currentVersion: "Current fork version", currentVersionHelp: "Owned-fork version currently running on this service instance.", latestVersion: "Upstream candidate", latestVersionHelp: "Candidate patch version retrieved from the original project's GitHub Releases feed. It is not the current production contract.", statusLabel: "Candidate status", statusLabelHelp: "Comparison used for manual review and selective cherry-picking only.", checkedAt: "Last check", checkedAtHelp: "Most recent successful retrieval of upstream candidate information.", checkNow: "Check upstream candidates", viewRelease: "View candidate", openRelease: "Open candidate Release", releaseNotes: "Candidate release notes", releaseNotesHelp: "Unreviewed change summary published by the original project.", noReleaseNotes: "No notes are available for this candidate.", notChecked: "Not fetched", neverChecked: "No successful check yet", available: "Upstream candidate {{version}} found", currentSummary: "Owned fork running {{version}}", status: { unchecked: "Not checked", up_to_date: "No newer upstream candidate", update_available: "Upstream candidate found", check_failed: "Candidate check failed" } },
