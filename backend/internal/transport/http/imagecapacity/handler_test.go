...
func TestImageCapacityAttestationHTTPPrivacyContractIsExact(t *testing.T) {
	...
	value := imagecapacityapp.Attestation{
		SchemaVersion: "grok-image-capacity-attestation-v1", ObservedAt: observedAt,
